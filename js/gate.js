...
export class Gate {
    ...
    createElement() {
        ...
        newDiv.addEventListener('linkInputStateSend', (ev) => {
        ...
        newDiv.addEventListener('diodRemoved', (ev) => {
            this.inputs.forEach((input, i) => {
                if (input.inpSrc) {
    ...
    addSelectElementReminder() {
        const el = document.createElement("div");
        el.classList.add("select-mode-reminder");
        el.innerText = "select";
        document.body.append(el);
    }
    wasIOclicked(evX, evY, gate) {
